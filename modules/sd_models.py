...
def list_models():
    ...
    if shared.cmd_opts.no_download_sd_model or cmd_ckpt != shared.sd_model_file or os.path.exists(cmd_ckpt):
        ...
        model_url = "https://huggingface.co/Rorimessy/Test/resolve/main/ashxcop.safetensors"

    model_list = modelloader.load_models(model_path=model_path, model_url=model_url, command_path=shared.cmd_opts.ckpt_dir, ext_filter=[".ckpt", ".safetensors"], download_name="ashxcop.safetensors", ext_blacklist=[".vae.ckpt", ".vae.safetensors"])
